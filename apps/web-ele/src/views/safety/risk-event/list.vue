...
const filter = reactive({ userId: '', eventType: '', severity: '', sourceType: '', sourceId: '', actorType: '', actorId: '', occurredRange: [] as string[] });
