...
const filter = reactive({ reviewId: '', targetType: '', status: 'manual_review', riskLevel: '', category: '' });
  ...
  <div class="p-5">
    <ElCard shadow="never">
      ...
      <div class="mb-4 flex flex-wrap gap-3">
        ...
        <ElSelect v-model="filter.targetType" clearable placeholder="全部对象" class="!w-36"><ElOption label="漂流瓶" value="bottle" /><ElOption label="消息" value="message" /><ElOption label="媒体" value="media" /></ElSelect>
      ...
      <ElTable v-loading="loading" :data="rows" row-key="reviewId">
        ...
        <ElTableColumn prop="targetType" label="对象类型" width="100" />
        <ElTableColumn prop="targetEntityId" label="对象 ID" min-width="115" />
        <ElTableColumn prop="scene" label="场景" min-width="120" />
        <ElTableColumn prop="riskLevel" label="风险等级" width="110" />
        <ElTableColumn prop="status" label="状态" width="125" />
