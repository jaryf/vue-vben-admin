...
const scheduleTimeText = (value?: null | string) => value ? `${new Date(value).toLocaleString('zh-CN', { timeZone: 'Asia/Kolkata', hour12: false })}（Asia/Kolkata）` : '—';
